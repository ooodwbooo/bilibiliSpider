...
时间 : 2019/08/6--21:53
作者 : 'dwb'
参考 : https://github.com/muzuiget/niconvert并进行精简
'''
import re
...
Style: AcplayDefault, %(font_name)s, %(font_size)s, &H00FFFFFF, &H00FFFFFF, &H00000000, &H00000000, 0, 0, 0, 0, 100, 100, 0.00, 0.00, 1, 1, 0, 2, 20, 20, 20, 1
...
class AssSubtitle:
    ...
    def init_end_seconds(self):
        ...
        # print(type(end_seconds), type(self.tune_seconds))
